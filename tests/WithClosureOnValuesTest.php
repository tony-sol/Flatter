...
class WithClosureOnValues extends AbstractTest
{
    /**
     * {@inheritDoc}
     *
    ...
    {
        return [
            'Flattened with transform values to dash-surrounded' => [
                [
                    'array' => [
                        'key'   => 'value',
                        'inner' => [
    ...
    {
        return [
            'Inflated with transform values to dash-surrounded' => [
                [
                    'array_key'                  => 'value',
                    'array_inner_key'            => 1,
                    'array_inner_with_separator' => 2,
    ...
    {
        return (new Flatter($data))->applyClosureToValues(static fn(mixed $value): string => "--{$value}--");
    }
}
